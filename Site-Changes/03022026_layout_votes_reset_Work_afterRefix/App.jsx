            ...
            <button 
              onClick={async () => { 
                ...
                try {
                  ...
                  fetchData(); 
                  alert("Game Reset! Database and local browser memory cleared. Ready for Season 50!"); 
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(160px, 1fr))', gap: '20px' }}>
              {atRiskLegends.map(c => (
                <div key={c.id} style={{ position: 'relative' }}>
                  ...
                  <button 
                    // FIX: Disable card if user has voted
                    disabled={(isVotingLocked && !isAdmin) || c.is_immune || hasVoted} 
                    // FIX: Prevent clicking if user has voted
                    ...
                    style={{ 
                      ...
                      // FIX: Update cursor to show not-allowed when voted
