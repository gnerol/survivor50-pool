...
            setTargetTribes([...targetTribes, { id: Date.now(), name: '', color: '#eab308' }]); // Yellow default
            triggerHaptic();
      };
...
                  if (!targetTribe || !targetTribe.name) return Promise.resolve(); // Skip if incomplete
                  
...
                  {/* --- NEW: DYNAMIC TRIBE EDITOR OVERLAY (ADMIN ONLY) --- */}
